...
Jednym z moich ulubionych wyrażeń po angielsku jest <i>out of the box</i>, czyli dosłownie „poza pudełkiem”,<br/> nieszablonowo. Wierzę, że kiedy chce się coś osiągnąć, warto nie raz zakwestionować schematyczne podejście i pójść<br/> mniej utartą ścieżką, która może być bardziej intuicyjna i skuteczna<br/>
...
w większej harmonii ze sobą.<br/>

Odkrycie, że podobnie można podejść do przyswajania wiedzy jest dla mnie fascynujące<br/>

i napawające nadzieją na to, że to co do tej pory mogło wydawać się nieosiągalne, bo opór był zbyt duży, staje się<br/> możliwe.​<br/>
